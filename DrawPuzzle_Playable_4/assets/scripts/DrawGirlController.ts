...
export default class DrawGirlController extends cc.Component {
    ...
    onTouchEnd(event) {
        ...
        if (this.girlDrawPoint >= 4 && this.borderIsTouched == false && this.drawOut == false) {
        ...
        else if (this.girlDrawPoint < 4 || this.borderIsTouched == true || this.drawOut == true) {
            this.graphics.clear();
